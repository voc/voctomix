...
class CommandsSetVideosAndComposite(CommandsTestBase):
    def test_returns_expected_notifications(self):
        ...
        self.assertContainsNotification(notifications, 'composite_mode', 'fullscreen')
    ...
    def test_can_set_video_b_and_composite_mode(self):
        self.commands.set_videos_and_composite("*", "grabber", "side_by_side_equal")
    ...
    def test_can_set_video_a_and_b_and_composite_mode(self):
        self.commands.set_videos_and_composite("cam1", "grabber", "side_by_side_equal")
    ...
    def test_can_set_composite_mode(self):
        self.commands.set_videos_and_composite("*", "*", "side_by_side_preview")
    ...
    def test_setting_composite_mode_with_a_and_b_source_does_not_apply_default_source(
        self,
    ):
