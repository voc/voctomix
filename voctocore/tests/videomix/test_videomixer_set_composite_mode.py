...
class VideomixerSetCompositeMode(VoctomixTest):
    ...
    def test_can_set_composite_mode(self):
        ...
        self.assertEqual(
            self.videomixer.compositeMode, CompositeModes.side_by_side_preview
        )
    ...
    def test_set_composite_mode_does_not_set_default_source_if_requested(self):
        ...
        self.videomixer.setCompositeMode(
            CompositeModes.side_by_side_preview, apply_default_source=False
        )
